<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="<?=base_url('template')?>/assets/css/vendors/datatable-extension.css">	 -->
		<link rel="stylesheet" type="text/css" href="<?=base_url('template')?>/assets/css/vendors/rating.css">
		<link rel="stylesheet" type="text/css" href="<?=base_url('template')?>/assets/css/sweetalert2.min.css">
		<!-- <link rel="stylesheet" type="text/css" href="<?=base_url('template')?>/assets/css/vendors/range-slider.css"> -->
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
